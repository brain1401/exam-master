...
export async function POST(req: NextRequest) {
  ...
  if (GenerateQuestionResponseSchema.safeParse(parsedText).success === false) {
    console.log(GenerateQuestionResponseSchema.safeParse(parsedText));
