...
export default function TestPage() {
  ...
  const handleClick = async () => {
    let generated = generateQuestionResponse;
    ...
    try {
      ...
      do {
        const res = await axios.post<GenerateQuestionResponse>(
          ...
          {
            prevQuestions: JSON.stringify(generated?.questions) || "",
            source: document,
            totalQuestions: generated?.totalQuestions ?? 0,
            questionCount: generated?.questionCount ?? 0,
          },
        );
        const data = res.data;

        generatedQuestions += data.questionCount || 0;
        ...
        generated = {
          ...
          questions: [...(generated?.questions ?? []), ...data.questions],
        };

        setStep((step) => step + 1);

        console.log("generated :", generated);
      } while (generated.totalQuestions > (generated.generatedQuestions || 0));

      setGenerateQuestionResponse({
        ...generated,
        questions: generated.questions.sort((a, b) =>
  ...
  useEffect(() => {
    console.log("generateQuestionResponse :", generateQuestionResponse);
